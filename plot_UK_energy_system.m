...
for i = 1:size(mpc.Gline,1)
    lat1 = GBlat(fb_index(i)); lon1 = GBlon(fb_index(i));
    lat2 = GBlat(tb_index(i)); lon2 = GBlon(tb_index(i));
    ...
    text(latm2, lonm2, sprintf('%.2f', mpc.Gline(i,3)), ...
        'FontSize', 9, 'Color', 'k', ...
